...
application2_path = os.path.dirname(sys.executable)
...
input_path = os.path.join(application2_path, '/Users/raulgiron/Desktop/AutomateWithPython/pivot_table_supermarket_sales.xlsx')
...
output_path = os.path.join(application2_path, f'report_{month}.xlsx')
wb.save(output_path)
